    ...
    <v-dialog v-model="dialog" content-class="draggable-dialog topleft-dialog" hide-overlay persistent no-click-animation width="300px">
        ...
        <v-card>
            ...
            <v-card-text>
                ...
                <v-row>
                    <v-text-field v-model="dimx" label="Dim X" type="number" step="1" min="1" required />
                    <v-text-field v-model="dimy" label="Dim Y" type="number" step="1" min="1" required />
                </v-row>
                <v-row> Spacing: </v-row>
                <v-row>
                    <v-text-field v-model="spacingX" label="X Spacing (mm)" type="number" step="1" min="0" required />
                    <v-text-field v-model="spacingY" label="Y Spacing (mm)" type="number" step="1" min="0" required />
                </v-row>
            </v-card-text>
            <v-divider />
