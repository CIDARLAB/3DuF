    ...
    data() {
        return {
            ...
            toolTree: {
                ...
                Droplet: ["NOZZLE DROPLET GENERATOR", "DROPLET CAPACITANCE SENSOR", "DROPLET MERGER", "DROPLET MERGER JUNCTION", "PICOINJECTOR", "DROPLET SPLITTER", "DROPLET GENERATOR FLOW FOCUS"]
            },
