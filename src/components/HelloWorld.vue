<template>
    <div>
        <div id="main_window" class="mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--overlay-drawer-button">
            <div id="button_drawer" class="mdl-layout__drawer">
                ...
                <nav class="mdl-navigation" id="general-tools">
                    ...
                    <div class="button_row">
                        <a id="select_button" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised feature-button"> Select Tool</a>
                    </div>

                    <div class="button_row">
                        <a id="insert_text_button" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--raised feature-button"> Insert Text</a>
                    </div>
                </nav>
                ...
                <nav class="mdl-navigation">
                    ...
                    <a id="metafluidics_save" class="mdl-button mdl-js-button mdl-js-ripple-effect view-button" target="_blank" href="https://metafluidics.org/create-part/"
                        >Publish on Metafluidics</a
                    >
            ...
            <main class="mdl-layout__content">
                <div id="view_container" class="page-content">
                    <div id="canvas_block" class="shown-block fade-transition">
                        <canvas id="c" tabindex="0" width="800" height="800" resize></canvas>
                    </div>
        ...
        <div id="toolbar-button-panel">
            ...
            <div class="mdl-tooltip mdl-tooltip--left" for="grid-toolbar-show-button">Grid Settings</div>
        </div>
        ...
        <div id="contextMenu" style="z-index: 19; left: 500px; top: 500px; position: absolute; background-color: #fff" class="hidden-block">
            <div id="rename_component_textfield" class="collapse">
                ...
                <div class="mdl-tooltip" data-mdl-for="context_button_rename">Save</div>
        ...
        <div id="moveBox" style="z-index: 20; left: 250px; top: 30px; position: absolute; background-color: #fff" class="hidden-block">
            ...
            <button id="save-position" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect">Save</button>
            <!-- Raised button with ripple -->
            <button id="cancel-edit-position" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect">Cancel</button>
        </div>
        ...
        <div id="arrayBox" style="z-index: 20; left: 250px; top: 30px; position: absolute; background-color: #fff" class="hidden-block">
            ...
            <!-- Raised button with ripple -->
            <button id="generate-replication" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect">Generate</button>
            <!-- Raised button with ripple -->
            <button id="cancel-replication" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect">Cancel</button>
        </div>
        ...
        <div id="bottom-info-bar" style="z-index: 9; bottom: 2px; right: 50px; position: absolute">Grid Size : <label id="sm-resolution"></label></div>
            ...
            <div class="mdl-dialog__content">
                <div class="demo-card-wide mdl-card mdl-shadow--2dp">
                    ...
                    <div class="mdl-card__supporting-text">
                        ...
                        3DuF is microfluidic design environment developed by <a href="http://cidarlab.org" target="_blank">CIDAR</a>. For any help or queries, please send an email
                        to <a href="mailto: 3dufhelp@gmail.com"> 3dufhelp@gmail.com </a>. Source code, issue tracking and feature requests are available at
        ...
        <dialog id="intro_help_dialog" class="mdl-dialog" style="overflow-y: auto">
            ...
            <div class="mdl-dialog__content">
                <div style="overflow-y: visible; max-height: 600px">
                    ...
                    <p>
                        Sanka, Radhakrishna, Joshua Lippai, Dinithi Samarasekera, Sarah Nemsick, and Douglas Densmore. <br />
        ...
        <dialog id="change_all_dialog" class="mdl-dialog">
            <div class="mdl-dialog__content">
                <!-- Textfield with Floating Label -->
                <h5>Change All Components: <span id="component_type_span"></span></h5>
            </div>
        ...
        <dialog id="damp_fabricate_dialog" class="mdl-dialog">
            ...
            <div class="mdl-dialog__content">
                <!-- Textfield with Floating Label -->
                <h6>Enter your contact information:</h6>
                <form action="#">
                    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
