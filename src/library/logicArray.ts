...
export default class LogicArray extends Template {
  ...
  __drawFlow(params: { [k: string]: any }) {
    ...
    let rec: paper.Rectangle | paper.PathItem = new paper.Path.Rectangle(
      topLeft,
      bottomRight
    );
    ...
    topLeft = new paper.Point(
      x + (2 * inWidth) / 3 - controlChannelWidth,
      y - flowChannelWidth / 2 - controlChannelWidth
    );
    ...
    /// / second left
    topLeft = new paper.Point(
      x + inWidth + pathLength / 2 - extraLength - controlChannelWidth,
      y - flowChannelWidth / 2 - controlChannelWidth
    );
    bottomRight = new paper.Point(
      x + inWidth + pathLength / 2 - extraLength + controlChannelWidth,
    ...
    bottomRight = new paper.Point(
      x + inWidth,
      y - topDistance + flowChannelWidth / 2
    );

    rec = new paper.Path.Rectangle(topLeft, bottomRight);

    topLeft = new paper.Point(
      x + inWidth / 3 - controlChannelWidth,
      y - topDistance - flowChannelWidth / 2 - controlChannelWidth
    );
    bottomRight = new paper.Point(
      x + inWidth / 3 + controlChannelWidth,
      y - topDistance + flowChannelWidth / 2 + controlChannelWidth
    ...
    topLeft = new paper.Point(
      x + inWidth - flowChannelWidth / 2,
      y - topDistance - topDistance / 2
    );
    bottomRight = new paper.Point(
      x + inWidth + flowChannelWidth / 2,
      y - topDistance + topDistance / 2
    ...
    bottomRight = new paper.Point(
      x + inWidth + pathLength,
      y - topDistance - topDistance / 2 + flowChannelWidth
    );

    ret.addChild(new paper.Path.Rectangle(topLeft, bottomRight));

    topLeft = new paper.Point(
      x + inWidth + pathLength - flowChannelWidth,
      y - topDistance - topDistance / 2
    );
    bottomRight = new paper.Point(
      x + inWidth + pathLength,
    ...
    /// / left
    topLeft = new paper.Point(
      x + pathLength / 2 - extraLength - controlChannelWidth,
      y - topDistance / 2 - flowChannelWidth - controlChannelWidth
    );
    bottomRight = new paper.Point(
      x + pathLength / 2 - extraLength + controlChannelWidth,
      y - topDistance / 2 + controlChannelWidth
    );
    rec = rec.subtract(new paper.Path.Rectangle(topLeft, bottomRight));
    ...
    /// / right
    topLeft = new paper.Point(
      x + 2 * inWidth + pathLength / 2 + extraLength - controlChannelWidth,
      y - topDistance / 2 - flowChannelWidth - controlChannelWidth
    );
    bottomRight = new paper.Point(
      x + 2 * inWidth + pathLength / 2 + extraLength + controlChannelWidth,
    ...
    // insde middle ** cut
    topLeft = new paper.Point(
      x + inWidth + pathLength / 2 - flowChannelWidth / 2,
      y - topDistance / 2
    );
    bottomRight = new paper.Point(
      x + inWidth + pathLength / 2 + flowChannelWidth / 2,
    ...
    /// / top
    topLeft = new paper.Point(
      x + inWidth + pathLength / 2 - flowChannelWidth / 2 - controlChannelWidth,
      y - topDistance / 2 + 4 * spacing - controlChannelWidth
    );
    bottomRight = new paper.Point(
      x + inWidth + pathLength / 2 + flowChannelWidth / 2 + controlChannelWidth,
      y - topDistance / 2 + 4 * spacing + controlChannelWidth
    ...
    // inside left ** cut
    topLeft = new paper.Point(
      x + pathLength / 2 - flowChannelWidth / 2,
      y - topDistance - topDistance / 4
    );
    bottomRight = new paper.Point(
      x + pathLength / 2 + flowChannelWidth / 2,
      y + topDistance + topDistance / 4
    ...
    /// / top
    topLeft = new paper.Point(
      x + pathLength / 2 - flowChannelWidth / 2 - controlChannelWidth,
      y - topDistance / 2 - 5 * spacing - controlChannelWidth
    );
    bottomRight = new paper.Point(
      x + pathLength / 2 + flowChannelWidth / 2 + controlChannelWidth,
      y - topDistance / 2 - 5 * spacing + controlChannelWidth
    ...
    topLeft = new paper.Point(
      x + pathLength / 2 - flowChannelWidth / 2 - controlChannelWidth,
      y - topDistance / 2 + 3 * spacing - controlChannelWidth
    );
    bottomRight = new paper.Point(
      x + pathLength / 2 + flowChannelWidth / 2 + controlChannelWidth,
      y - topDistance / 2 + 3 * spacing + controlChannelWidth
    ...
    let circ = new paper.Path.Circle(
      new paper.Point(x + pathLength / 2, y - topDistance - topDistance / 4),
      portRadius
    );
    ...
    // inside right ** cut
    topLeft = new paper.Point(
      x + 2 * inWidth + pathLength / 2 - flowChannelWidth,
      y - topDistance - topDistance / 4
    );
    bottomRight = new paper.Point(
      x + 2 * inWidth + pathLength / 2,
      y + topDistance + topDistance / 4
    );
    ...
    /// / top
    topLeft = new paper.Point(
      x + 2 * inWidth + pathLength / 2 - flowChannelWidth - controlChannelWidth,
      y - topDistance / 2 - 2 * spacing - controlChannelWidth
    );
    bottomRight = new paper.Point(
      x + 2 * inWidth + pathLength / 2 + controlChannelWidth,
      y - topDistance / 2 - 2 * spacing + controlChannelWidth
    );
    rec = rec.subtract(new paper.Path.Rectangle(topLeft, bottomRight));
    ...
    circ = new paper.Path.Circle(
      new paper.Point(
        x + 2 * inWidth + pathLength / 2 - flowChannelWidth / 2,
        y - topDistance - topDistance / 4
      ),
      portRadius
    );
  ...
  __drawControl(params: { [k: string]: any }) {
    ...
    let topLeft = new paper.Point(
      x + inWidth / 3 - controlChannelWidth / 2,
      y - topDistance - topDistance / 2 - extraLength
    );
    ...
    // cnotrol 25
    topLeft = new paper.Point(
      x + (2 * inWidth) / 3 - controlChannelWidth / 2,
      y - topDistance - topDistance / 2 - extraLength
    );
    bottomRight = new paper.Point(
      x + (2 * inWidth) / 3 + controlChannelWidth / 2,
    ...
    topLeft = new paper.Point(
      x + 2 * inWidth + pathLength / 2 - flowChannelWidth / 2,
      y - topDistance / 2 - 2 * spacing - controlChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x + inWidth + pathLength + extraLength,
      y - topDistance / 2 - 2 * spacing + controlChannelWidth / 2
    );
    control.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
    ...
    // control 7
    topLeft = new paper.Point(
      x + inWidth + pathLength / 2 + extraLength,
      y - topDistance / 2 - 3 * spacing - controlChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x + inWidth + pathLength + extraLength,
      y - topDistance / 2 - 3 * spacing + controlChannelWidth / 2
    ...
    topLeft = new paper.Point(
      x + inWidth + pathLength / 2 + extraLength - controlChannelWidth / 2,
      y - topDistance / 2 - 3 * spacing - controlChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x + inWidth + pathLength / 2 + extraLength + controlChannelWidth / 2,
    ...
    topLeft = new paper.Point(
      x + inWidth + pathLength / 2 - extraLength,
      y - topDistance / 2 - 4 * spacing - controlChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x + inWidth + pathLength + extraLength,
      y - topDistance / 2 - 4 * spacing + controlChannelWidth / 2
    ...
    topLeft = new paper.Point(
      x + pathLength / 2,
      y - topDistance / 2 - 5 * spacing - controlChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x + inWidth + pathLength + extraLength,
      y - topDistance / 2 - 5 * spacing + controlChannelWidth / 2
    ...
    // control 4
    topLeft = new paper.Point(
      x + pathLength / 2 - extraLength,
      y - topDistance / 2 - 6 * spacing - controlChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x + inWidth + pathLength + extraLength,
      y - topDistance / 2 - 6 * spacing + controlChannelWidth / 2
    ...
    topLeft = new paper.Point(
      x + pathLength / 2 - extraLength - controlChannelWidth / 2,
      y - topDistance / 2 - 6 * spacing - controlChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x + pathLength / 2 - extraLength + controlChannelWidth / 2,
    ...
    // control 9
    topLeft = new paper.Point(
      x + 2 * inWidth + pathLength / 2 + extraLength,
      y - topDistance / 2 + 2 * spacing - controlChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x + inWidth + pathLength + extraLength,
    ...
    topLeft = new paper.Point(
      x + 2 * inWidth + pathLength / 2 + extraLength - controlChannelWidth / 2,
      y - topDistance / 2
    );
    bottomRight = new paper.Point(
      x + 2 * inWidth + pathLength / 2 + extraLength + controlChannelWidth / 2,
  ...
  getPorts(params: { [k: string]: any }) {
    ...
    ports.push(
      new ComponentPort(
        inWidth + pathLength + extraLength,
        -topDistance / 2 - 6 * spacing,
        "4",
    ...
    ports.push(
      new ComponentPort(
        inWidth / 3,
        -topDistance - topDistance / 2 - extraLength,
        "24",
        LogicalLayerType.CONTROL
      )
    );
  ...
  __drawCell(params: { [k: string]: any }) {
    ...
    // top left
    let topLeft = new paper.Point(
      x + pathLength / 2 - chamberWidth / 2,
      y - topDistance / 2 - chamberLength / 2 - flowChannelWidth / 2
    );
    let bottomRight = new paper.Point(
      x + pathLength / 2 + chamberWidth / 2,
      y - topDistance / 2 + chamberLength / 2 - flowChannelWidth / 2
