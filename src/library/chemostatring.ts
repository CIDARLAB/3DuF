...
export default class ChemostatRing extends Template {
  ...
  getPorts(params: { [k: string]: any }) {
    ...
    ports.push(
      new ComponentPort(
        -chemostatLength / 3 - chemostatLength / 2,
        -chemostatLength / 3,
        "1",
    ...
    ports.push(
      new ComponentPort(
        -chemostatLength / 3 - chemostatLength / 5,
        -chemostatLength / 3 - chemostatLength / 3,
        "2",
        LogicalLayerType.FLOW
      )
    );
    ...
    ports.push(
      new ComponentPort(
        -chemostatLength / 3 - chemostatLength / 5 - controlSpacing - radius,
        controlendpoint,
        "5",
        LogicalLayerType.CONTROL
      )
    );
    // 2
    ports.push(
      new ComponentPort(
        -chemostatLength / 3 - chemostatLength / 5 + 1.3 * radius,
        controlendpoint,
        "6",
        LogicalLayerType.CONTROL
      )
    ...
    ports.push(
      new ComponentPort(
        -chemostatLength / 3 - chemostatLength / 5 + 1.7 * radius,
        controlendpoint,
        "7",
        LogicalLayerType.CONTROL
      )
    ...
    ports.push(
      new ComponentPort(
        originx - controlSpacing - 0.5 * radius,
        controlendpoint,
        "11",
        LogicalLayerType.CONTROL
      )
    ...
    ports.push(
      new ComponentPort(
        controlendpoint,
        originy - controlSpacing - 0.5 * radius,
        "17",
        LogicalLayerType.CONTROL
      )
    );
    ...
    ports.push(
      new ComponentPort(
        originx + 0.4 * controlSpacing + 0.3 * controlSpacing,
        2 * chemostatLength,
        "31",
        LogicalLayerType.CONTROL
      )
  ...
  __drawFlow(params: { [k: string]: any }) {
    ...
    let bottomRight = new paper.Point(
      x + chemostatChannelWidth + chemostatLength,
      y + chemostatChannelWidth
    );
    ...
    bottomRight = new paper.Point(
      x + chemostatLength,
      y + chemostatLength + chemostatChannelWidth
    );
    serp.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
    ...
    topLeft = new paper.Point(
      x +
        chemostatChannelWidth / 2 +
        chemostatLength / 4 -
        flowChannelWidth / 2,
      y + chemostatChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x +
        chemostatChannelWidth / 2 +
        chemostatLength / 4 +
        flowChannelWidth / 2,
      y + chemostatChannelWidth / 2 + (2 * chemostatLength) / 5
    );
    serp.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
    ...
    topLeft = new paper.Point(
      ...
      y + chemostatChannelWidth / 2 + chemostatLength / 5 - flowChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x + chemostatChannelWidth / 2 + chemostatLength,
      y + chemostatChannelWidth / 2 + chemostatLength / 5 + flowChannelWidth / 2
    );
    serp.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
    ...
    bottomRight = new paper.Point(
      x + chemostatChannelWidth / 2 + chemostatLength / 4,
      y +
        chemostatChannelWidth / 2 +
        (4 * chemostatLength) / 5 +
        flowChannelWidth / 2
    ...
    topLeft = new paper.Point(
      x +
        ...
        chemostatLength / 4 -
        flowChannelWidth / 2,
      y + chemostatChannelWidth / 2 + chemostatLength / 2
    );
    bottomRight = new paper.Point(
      x +
        chemostatChannelWidth / 2 +
    ...
    bottomRight = new paper.Point(
      x + chemostatChannelWidth / 2 + (5 * chemostatLength) / 7,
      y + chemostatChannelWidth / 2 + chemostatLength / 2 + flowChannelWidth / 2
    );
    serp.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
    ...
    // calc H
    const xval = Math.abs(
      (5 * chemostatLength) / 7 - (3 * chemostatLength) / 5
    );
    const yval = Math.abs(
      chemostatChannelWidth / 2 +
        chemostatLength / 2 -
        (chemostatChannelWidth / 2 + (2 * chemostatLength) / 5)
    );
    ...
    topLeft = new paper.Point(
      x + (5 * chemostatLength) / 6 - flowChannelWidth / 2,
      y + chemostatChannelWidth / 2 + (7 * chemostatLength) / 11
    );
    bottomRight = new paper.Point(
      x + (5 * chemostatLength) / 6 + flowChannelWidth / 2,
      y + chemostatChannelWidth / 2 + chemostatLength
    );
    serp.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
    ...
    topLeft = new paper.Point(
      x +
        ...
        (3 * chemostatLength) / 7 -
        flowChannelWidth / 2,
      y + chemostatChannelWidth / 2 + (4 * chemostatLength) / 6
    );
    bottomRight = new paper.Point(
      x +
        chemostatChannelWidth / 2 +
    ...
    center = new paper.Point(
      x + chemostatChannelWidth / 2 + (3 * chemostatLength) / 7,
      y + chemostatChannelWidth / 2 + (4 * chemostatLength) / 6
    );
    ...
    topLeft = new paper.Point(
      x - chemostatLength / 3,
      y + chemostatLength / 5 - flowChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x,
      y + chemostatLength / 5 + flowChannelWidth / 2
    ...
    // left top vert
    topLeft = new paper.Point(
      x - chemostatLength / 3 - flowChannelWidth / 2,
      y - chemostatLength / 3
    );
    bottomRight = new paper.Point(
      x - chemostatLength / 3 + flowChannelWidth / 2,
    ...
    topLeft = new paper.Point(
      x - chemostatLength / 3 - chemostatLength / 2,
      y - chemostatLength / 3 - flowChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x - chemostatLength / 3 + chemostatLength / 2,
      y - chemostatLength / 3 + flowChannelWidth / 2
    ...
    // left flow port vert
    topLeft = new paper.Point(
      x - chemostatLength / 3 - chemostatLength / 5 - flowChannelWidth / 2,
      y - chemostatLength / 3 - chemostatLength / 3
    );
    bottomRight = new paper.Point(
      x - chemostatLength / 3 - chemostatLength / 5 + flowChannelWidth / 2,
      y - chemostatLength / 3
    ...
    topLeft = new paper.Point(
      x - chemostatLength / 5 - flowChannelWidth / 2,
      y + chemostatLength / 5
    );
    bottomRight = new paper.Point(
      x - chemostatLength / 5 + flowChannelWidth / 2,
    ...
    topLeft = new paper.Point(
      x - chemostatLength / 5,
      y + chemostatLength / 5 + chemostatLength / 2 - flowChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x,
      y + chemostatLength / 5 + chemostatLength / 2 + flowChannelWidth / 2
    ...
    topLeft = new paper.Point(
      x +
        ...
        chemostatLength / 4 -
        flowChannelWidth / 2,
      y + chemostatLength + chemostatChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x +
        chemostatChannelWidth / 2 +
    ...
    center = new paper.Point(
      x + chemostatChannelWidth + chemostatLength + (2 * chemostatLength) / 5,
      y + chemostatChannelWidth / 2 + (7 * chemostatLength) / 11 - radius
    );
    serp.addChild(new paper.Path.Circle(center, radius));
  ...
  __drawControl(params: { [k: string]: any }) {
    ...
    bottomRight = new paper.Point(
      x - chemostatLength / 3 - chemostatLength / 5 - controlSpacing,
      y - chemostatLength / 3 - bendDist + controlChannelWidth / 2
    );
    control.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
    ...
    topLeft = new paper.Point(
      x -
        ...
        controlSpacing -
        valvewidth / 2,
      y - chemostatLength / 3 - valvelength / 2
    );
    bottomRight = new paper.Point(
      x -
        chemostatLength / 3 -
    ...
    // 2
    topLeft = new paper.Point(
      x - chemostatLength / 3 - chemostatLength / 5 - valvelength / 2,
      y - chemostatLength / 3 - controlSpacing - valvewidth / 2
    );
    bottomRight = new paper.Point(
      x - chemostatLength / 3 - chemostatLength / 5 + valvelength / 2,
      y - chemostatLength / 3 - controlSpacing + valvewidth / 2
    ...
    topLeft = new paper.Point(
      x - chemostatLength / 3 - chemostatLength / 5,
      y - chemostatLength / 3 - controlSpacing - controlChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x - chemostatLength / 3 - chemostatLength / 5 + 1.3 * radius,
      y - chemostatLength / 3 - controlSpacing + controlChannelWidth / 2
    );
    control.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
    ...
    bottomRight = new paper.Point(
      x - chemostatLength / 3 - chemostatLength / 5 + 1.7 * radius,
      y - chemostatLength / 3 - bendDist + controlChannelWidth / 2
    );
    control.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
    ...
    // 7
    topLeft = new paper.Point(
      x + originx - controlChannelWidth / 2 - controlSpacing - 0.5 * radius,
      y + controlendpoint
    );
    bottomRight = new paper.Point(
      x + originx + controlChannelWidth / 2 - controlSpacing - 0.5 * radius,
    ...
    topLeft = new paper.Point(
      x + originx - controlChannelWidth / 2 - controlSpacing - 0.5 * radius,
      y + originy - bendDist - controlChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x + originx - controlSpacing,
      y + originy - bendDist + controlChannelWidth / 2
    );
    control.addChild(new paper.Path.Rectangle(topLeft, bottomRight));

    topLeft = new paper.Point(
      x + originx - controlSpacing - controlChannelWidth / 2,
      y + originy - bendDist - controlChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x + originx - controlSpacing + controlChannelWidth / 2,
    ...
    topLeft = new paper.Point(
      x + originx - controlSpacing - valvewidth / 2,
      y + originy - valvelength / 2
    );
    bottomRight = new paper.Point(
      x + originx - controlSpacing + valvewidth / 2,
      y + originy + valvelength / 2
    ...
    // 8
    topLeft = new paper.Point(
      x + originx - valvelength / 2,
      y + originy - controlSpacing - valvewidth / 2
    );
    bottomRight = new paper.Point(
      x + originx + valvelength / 2,
      y + originy - controlSpacing + valvewidth / 2
    ...
    topLeft = new paper.Point(
      x + originx,
      y + originy - controlSpacing - controlChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x + originx + 1.3 * radius,
      y + originy - controlSpacing + controlChannelWidth / 2
    );
    control.addChild(new paper.Path.Rectangle(topLeft, bottomRight));

    topLeft = new paper.Point(
      x + originx + 1.3 * radius - controlChannelWidth / 2,
      y + controlendpoint
    );
    bottomRight = new paper.Point(
      x + originx + 1.3 * radius + controlChannelWidth / 2,
    ...
    bottomRight = new paper.Point(
      x + originx + 1.7 * radius,
      y + originy - bendDist + controlChannelWidth / 2
    );
    control.addChild(new paper.Path.Rectangle(topLeft, bottomRight));

    topLeft = new paper.Point(
      x + originx + 1.7 * radius - controlChannelWidth / 2,
      y + controlendpoint
    );
    bottomRight = new paper.Point(
      x + originx + 1.7 * radius + controlChannelWidth / 2,
    ...
    topLeft = new paper.Point(
      x + originx - bendDist - controlChannelWidth / 2,
      y + originy - controlSpacing - controlChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x + originx,
    ...
    topLeft = new paper.Point(
      x + originx - bendDist - controlChannelWidth / 2,
      y + originy - controlChannelWidth / 2 - controlSpacing - 0.5 * radius
    );
    bottomRight = new paper.Point(
      x + originx - bendDist + controlChannelWidth / 2,
      y + originy - controlSpacing
    );
    control.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
    ...
    bottomRight = new paper.Point(
      x + originx - controlSpacing + controlChannelWidth / 2,
      y + originy + 1.3 * radius
    );
    control.addChild(new paper.Path.Rectangle(topLeft, bottomRight));

    topLeft = new paper.Point(
      x + controlendpoint,
      y + originy + 1.3 * radius - controlChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x + originx - controlSpacing + controlChannelWidth / 2,
      y + originy + 1.3 * radius + controlChannelWidth / 2
    ...
    bottomRight = new paper.Point(
      x + originx - bendDist + controlChannelWidth / 2,
      y + originy + 1.7 * radius
    );
    control.addChild(new paper.Path.Rectangle(topLeft, bottomRight));

    topLeft = new paper.Point(
      x + controlendpoint,
      y + originy + 1.7 * radius - controlChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x + originx - bendDist + controlChannelWidth / 2,
      y + originy + 1.7 * radius + controlChannelWidth / 2
    ...
    // 25
    topLeft = new paper.Point(
      x + originx - 0.3 * controlSpacing - valvewidth / 2,
      y + originy - valvelength / 2
    );
    bottomRight = new paper.Point(
      x + originx - 0.3 * controlSpacing + valvewidth / 2,
    ...
    topLeft = new paper.Point(
      x + originx - controlChannelWidth / 2 - 0.3 * controlSpacing,
      y + originy
    );
    bottomRight = new paper.Point(
      x + originx + controlChannelWidth / 2 - 0.3 * controlSpacing,
    ...
    bottomRight = new paper.Point(
      x + originx + 0.5 * controlSpacing,
      y + originy + controlSpacing + controlChannelWidth / 2
    );
    control.addChild(new paper.Path.Rectangle(topLeft, bottomRight));

    topLeft = new paper.Point(
      x + originx + 0.5 * controlSpacing - controlChannelWidth / 2,
      y + originy + controlSpacing - controlChannelWidth / 2
    );
    bottomRight = new paper.Point(
      x + originx + 0.5 * controlSpacing + controlChannelWidth / 2,
    ...
    topLeft = new paper.Point(
      x + originx + 0.3 * controlSpacing - controlChannelWidth / 2,
      y + originy
    );
    bottomRight = new paper.Point(
      x + originx + 0.3 * controlSpacing + controlChannelWidth / 2,
    ...
    bottomRight = new paper.Point(
      x + originx + 0.3 * controlSpacing + 0.4 * controlSpacing,
      y + originy + bendDist + controlChannelWidth / 2
    );
    control.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
    ...
    topLeft = new paper.Point(
      x +
        ...
        0.4 * controlSpacing +
        0.3 * controlSpacing,
      y + originy - controlChannelWidth / 2 + bendDist
    );
    bottomRight = new paper.Point(
      x +
        originx +
    ...
    // 31
    topLeft = new paper.Point(
      x + originx + 0.55 * controlSpacing - valvewidth / 2,
      y + originy - valvelength
    );
    bottomRight = new paper.Point(
      x + originx + 0.55 * controlSpacing + valvewidth / 2,
      y + originy + valvelength
    ...
    topLeft = new paper.Point(
      x + originx + 0.55 * controlSpacing - controlChannelWidth / 2,
      y + originy
    );
    bottomRight = new paper.Point(
      x + originx + 0.55 * controlSpacing + controlChannelWidth / 2,
    ...
    // 32
    topLeft = new paper.Point(
      x + originx + 0.85 * controlSpacing - valvewidth / 2,
      y + originy - valvelength
    );
    bottomRight = new paper.Point(
      x + originx + 0.85 * controlSpacing + valvewidth / 2,
    ...
    topLeft = new paper.Point(
      x + originx + 0.85 * controlSpacing - controlChannelWidth / 2,
      y + originy
    );
    bottomRight = new paper.Point(
      x + originx + 0.85 * controlSpacing + controlChannelWidth / 2,
    ...
    // 33
    topLeft = new paper.Point(
      x + originx + 1.15 * controlSpacing - valvewidth / 2,
      y + originy - valvelength
    );
    bottomRight = new paper.Point(
      x + originx + 1.15 * controlSpacing + valvewidth / 2,
    ...
    topLeft = new paper.Point(
      x + originx + 1.15 * controlSpacing - controlChannelWidth / 2,
      y + originy
    );
    bottomRight = new paper.Point(
      x + originx + 1.15 * controlSpacing + controlChannelWidth / 2,
