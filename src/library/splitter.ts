...
export default class Splitter extends Template {
  ...
  getPorts(params: { [k: string]: any }) {
    ...
    ports.push(
      new ComponentPort(
        inletLength - outletWidth1 / 2,
        -inletWidth / 2 - outletLength1,
        "2",
    ...
    ports.push(
      new ComponentPort(
        inletLength - outletWidth2 / 2,
        inletWidth / 2 + outletLength2,
        "3",
        LogicalLayerType.FLOW
      )
    );
  ...
  render2D(params: { [k: string]: any }, key: string) {
    ...
    topLeft = new paper.Point(
      x + inletLength - outletWidth1,
      y - inletWidth / 2 - outletLength1
    );
    ...
    // outlet 2
    topLeft = new paper.Point(
      x + inletLength - outletWidth2,
      y + inletWidth / 2
    );
    bottomRight = new paper.Point(
      x + inletLength,
      y + inletWidth / 2 + outletLength2
    );
