...
export default class Merger extends Template {
  ...
  getPorts(params: { [k: string]: any }) {
    ...
    ports.push(
      new ComponentPort(
        inletLength + chamberLength + outletLength,
        0,
        "2",
  ...
  __renderFlow(params: { [k: string]: any }) {
    ...
    bottomRight = new paper.Point(
      x + inletLength + chamberLength + outletLength,
      y + outletWidth / 2
    );
  ...
  __renderIntegrate(params: { [k: string]: any }) {
    ...
    // right electrode
    topLeft = new paper.Point(
      x + inletLength + electrodeWidth + electrodeDistance,
      y - electrodeLength / 2
    );
    bottomRight = new paper.Point(
      x + inletLength + 2 * electrodeWidth + electrodeDistance,
      y + electrodeLength / 2
    );
