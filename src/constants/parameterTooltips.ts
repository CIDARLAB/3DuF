...
const COMMON: Record<string, string> = {
    ...
    edgeBend1: "Distance from mixer port 1 to the outer end of that incomplete bend. Ports stay on the rotation-center axis. Set this to half the connecting channel width so the mixer end and the pipe have the same width (no extra lip).",
