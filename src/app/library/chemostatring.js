...
export default class ChemostatRing extends Template{
    ...
    __setupDefinitions() {
        ...
        this.__defaults = {
            ...
            flowChannelWidth: 0.3 * 1000,
            controlChannelWidth: 0.15 * 1000,
            chemostatChannelWidth: 0.5 * 1000,
            radius: 1000,
            rotation: 0,
            volume: 0.8 * 1000 * 10 * 1000 * 4 * 1 * 1000,
            height: 1 * 1000
        };
    ...
    __drawFlow(params) {
        ...
        bottomRight = new paper.Point(x + chemostatChannelWidth/2 + chemostatLength/4 + flowChannelWidth/2,  y + chemostatChannelWidth/2 + 4 * chemostatLength/5 + flowChannelWidth/2);
        serp.addChild(new paper.Path.Rectangle(topLeft, bottomRight));

        // in middle middle hori
        topLeft = new paper.Point(x + chemostatChannelWidth/2 + chemostatLength/4 - flowChannelWidth/2, y + chemostatChannelWidth/2 + chemostatLength/2 - flowChannelWidth/2);
        ...
        // in tilt
        topLeft = new paper.Point(x + chemostatChannelWidth/2 + 3 * chemostatLength/5 - flowChannelWidth/2, y + chemostatChannelWidth/2 + 2 * chemostatLength/5 - flowChannelWidth/2);
        bottomRight = new paper.Point(x + chemostatChannelWidth/2 + 3 * chemostatLength/5 - flowChannelWidth/2 + hval, y + chemostatChannelWidth/2 + 2 * chemostatLength/5 + flowChannelWidth/2);
        serp.addChild(new paper.Path.Rectangle(topLeft, bottomRight).rotate(angt, new paper.Point(x + chemostatChannelWidth/2 + 3 * chemostatLength/5, y + chemostatChannelWidth/2 + 2 * chemostatLength/5)));
        ...
        topLeft = new paper.Point(x + chemostatChannelWidth/2 + 5 * chemostatLength/7 - flowChannelWidth/2, y + chemostatChannelWidth/2 + 7 * chemostatLength/11 - flowChannelWidth/2);
        ...
        bottomRight = new paper.Point(x + chemostatChannelWidth/2 + 3 * chemostatLength/5, y + chemostatLength + chemostatChannelWidth + chemostatLength/5 + flowChannelWidth/2);
        serp.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
        ...
        bottomRight = new paper.Point(x + chemostatChannelWidth/2 + chemostatLength/4 + flowChannelWidth/2, y + chemostatLength + chemostatChannelWidth + chemostatLength/5);
        serp.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
        ...
        bottomRight = new paper.Point(x + chemostatChannelWidth/2 + 3 * chemostatLength/5 + flowChannelWidth/2, y + chemostatLength + chemostatChannelWidth + 2 * chemostatLength/5);
        serp.addChild(new paper.Path.Rectangle(topLeft, bottomRight));

        // bottom right hori
        topLeft = new paper.Point(x + chemostatChannelWidth/2 + 3 * chemostatLength/5 - flowChannelWidth/2, y + chemostatLength + chemostatChannelWidth + 2 * chemostatLength/5 - flowChannelWidth/2);
        bottomRight = new paper.Point(x + chemostatChannelWidth + chemostatLength + 2 * chemostatLength/5, y + chemostatLength + chemostatChannelWidth + 2 * chemostatLength/5 + flowChannelWidth/2);
        serp.addChild(new paper.Path.Rectangle(topLeft, bottomRight));

        // right bottom vert
        topLeft = new paper.Point(x + chemostatChannelWidth + chemostatLength + 2 * chemostatLength/5 - flowChannelWidth/2, y + chemostatChannelWidth/2 + 7 * chemostatLength/11);
        bottomRight = new paper.Point(x + chemostatChannelWidth + chemostatLength + 2 * chemostatLength/5 + flowChannelWidth/2, y + chemostatLength + chemostatChannelWidth + 2 * chemostatLength/5 + flowChannelWidth/2);
        serp.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
        ...
        // right bottom hori
        topLeft = new paper.Point(x + chemostatChannelWidth + chemostatLength + chemostatLength/5, y + chemostatLength + chemostatChannelWidth + chemostatLength/5 - flowChannelWidth/2);
        bottomRight = new paper.Point(x + chemostatChannelWidth + chemostatLength + 2 * chemostatLength/5, y + chemostatLength + chemostatChannelWidth + chemostatLength/5 + flowChannelWidth/2);
        serp.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
        ...
        bottomRight = new paper.Point(x + chemostatChannelWidth + chemostatLength + chemostatLength/5 + flowChannelWidth/2, y + chemostatLength + chemostatChannelWidth + chemostatLength/5 + flowChannelWidth/2);
        serp.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
        ...
        bottomRight = new paper.Point(x + chemostatChannelWidth + chemostatLength + chemostatLength/5, y + chemostatChannelWidth/2 + 4 * chemostatLength/5 + flowChannelWidth/2);
        serp.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
        ...
        bottomRight = new paper.Point(x + chemostatChannelWidth + chemostatLength + chemostatLength/5, y + chemostatChannelWidth/2 + 2 * chemostatLength/5 + flowChannelWidth/2);
        serp.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
    ...
    __drawControl(params){
        ...
        topLeft = new paper.Point(x - chemostatLength/3 - chemostatLength/5 - controlChannelWidth/2 - controlSpacing - radius, y - chemostatLength/3 - bendDist - controlChannelWidth/2);
        ...
        topLeft = new paper.Point(x - chemostatLength/3 - chemostatLength/5 - controlSpacing - controlChannelWidth/2, y - chemostatLength/3 - bendDist - controlChannelWidth/2);
        ...
        bottomRight = new paper.Point(x - chemostatLength/3 - chemostatLength/5 + 1.3 * radius + controlChannelWidth/2, y - chemostatLength/3 - controlSpacing + controlChannelWidth/2);
        control.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
        ...
        bottomRight = new paper.Point(x - chemostatLength/3 - chemostatLength/5 + 1.7 * radius + controlChannelWidth/2, y - chemostatLength/3 - bendDist + controlChannelWidth/2);
        control.addChild(new paper.Path.Rectangle(topLeft, bottomRight));
