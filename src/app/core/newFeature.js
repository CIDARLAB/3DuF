...
class Feature {
    ...
    checkDefaults(values){
        ...
        let heritable = this.getHeritableParameters();
    ...
    getUniqueParameters(){
        return Registry.registeredFeatures[this.type].getUniqueParameters();
    }

    getHeritableParameters(){
        return Registry.registeredFeatures[this.type].getHeritableParameters();
    }

    getDefaultValues(){
        return Registry.featureDefaults[this.type];
    }
